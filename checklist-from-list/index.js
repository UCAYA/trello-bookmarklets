...
(function () {
  ...
  var bookletName = 'trello-bookmarklets_checklist-from-list';
  ...
  var start = function() {
    ...
    if(!parts) {
      gaCollect('start', 'checklist-from-list failed (No cards are open.)', 0);
      alert('No cards are open.');
      return false;
    }

    gaCollect('start', 'checklist-from-list success', 1);
